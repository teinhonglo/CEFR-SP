...
from util_viz import mean_pooling, read_corpus, CEFRDataset, convert_numeral_to_eight_levels
from model_base_viz import LevelEstimaterBase
from losses import *
...
class LevelEstimaterClassification(LevelEstimaterBase):
    ...
    def forward(self, batch):
        ...
        return (loss, predictions, logs, outputs_mean) if loss is not None else predictions
...
class LevelEstimaterContrastive(LevelEstimaterBase):
    ...
    def forward(self, batch):
        ...
        outputs = torch.nn.functional.normalize(outputs_mean)
...
class LevelEstimaterContrastiveSED(LevelEstimaterBase):
    ...
    def forward(self, batch):
        ...
        # positive: compute cosine similarity
        logits = self.negative_sed(outputs_mean, self.prototype.weight)
...
class LevelEstimaterContrastiveDot(LevelEstimaterBase):
    ...
    def forward(self, batch):
        ...
        # positive: compute cosine similarity
        outputs = outputs_mean #torch.nn.functional.normalize(outputs)
